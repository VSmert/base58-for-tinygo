...
func TrivialBase58Encoding(a []byte) string {
	return TrivialBase58EncodingAlphabet(a, DefaultAlphabet)
}
...
func TrivialBase58Decoding(str string) ([]byte, error) {
	return TrivialBase58DecodingAlphabet(str, DefaultAlphabet)
}
...
func TrivialBase58DecodingAlphabet(str string, alphabet *Alphabet) ([]byte, error) {
	...
	for i := range src[j:] {
		...
		if c == -1 {
			return nil, errors.New("illegal base58 data at input index")
		}
		n.Mul(n, bn58)
